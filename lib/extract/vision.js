...
const adapters = {
  ...
  /** Llama 3.2 Vision and friends: OpenAI-compatible chat completions. */
  chat: {
...
const adapterFor = model => (adapters.moondream.matches(model) ? adapters.moondream : adapters.chat);
