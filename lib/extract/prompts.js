...
/** Re-read one uncertain field from a cropped region. */
const fieldRereadPrompt = (field, docType) =>
  `This is a cropped region of a ${docType} document containing one field: ${FIELD_HINTS[field] || field}.
Transcribe it exactly as printed. Reply with JSON only:
{"${field}": "string or null"}
Return null if the crop is unreadable. Do not guess.`;
